var Layout = function() {
    var e = "layouts/layout2/img/",
        ...
        h = function() {
            var e = $("body");
            $(".sidebar-toggler").on("click", function(a) {
                var i = $(".page-sidebar"),
                    t = $(".page-sidebar-menu");
                $(".sidebar-search").removeClass("open"), e.hasClass("page-sidebar-closed") ? (console.log("sidebar true"), e.removeClass("page-sidebar-closed"), t.removeClass("page-sidebar-menu-closed"), Cookies && Cookies.set("sidebar_closed", "0")) : (console.log("sidebar false"), e.addClass("page-sidebar-closed"), t.addClass("page-sidebar-menu-closed"), e.hasClass("page-sidebar-fixed") && t.trigger("mouseleave"), Cookies && Cookies.set("sidebar_closed", "1")), $(window).trigger("resize")
            })
        },
        u = function() {
